...
public class Main {
    ...
    public static double moveOpX(double num)
    {//Move Operator for X
        Random random= new Random();
        double neigh = num+random.nextGaussian();
        return neigh;
    }
    public static double moveOpY(double num2)
    {//Move Operator Y
